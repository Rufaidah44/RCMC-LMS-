<%@ Page Title="" Language="C#" MasterPageFile="~/Master Pages/Lbary.Master" AutoEventWireup="true" CodeBehind="NewBook.aspx.cs" Inherits="RCMC.Forms.NewBook" %>
    ...
    <asp:Panel ID="Panel1" runat="server">
       <table align="center" style="background-color:peru; opacity: 0.8; filter: alpha(opacity=50); font-family: 'Century Gothic'; color: #5B0000; " class="auto-style31">
        ...
        <tr>
                    ...
                    <td class="auto-style33">
                        <asp:TextBox ID="SIDTBox" runat="server" Height="24px" required="" style="margin-left: 0px" Width="90%"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="auto-style24" colspan="3">
                        <asp:TextBox ID="BNTBox" runat="server" Height="22px" required style="margin-left: 0px" Width="70%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style34">
                    ...
                    <td class="auto-style33">
                        <asp:TextBox ID="BENTBox" runat="server" style="margin-left: 0px" Width="90%" required Height="23px" ></asp:TextBox>
                    </td>
                </tr>
        <tr>
                    <td class="auto-style34">
                    ...
                    <td class="auto-style33">
                        <asp:TextBox ID="PYTBox" runat="server" Height="25px" required="" style="margin-left: 0px" Width="90%"></asp:TextBox>
                    </td>
                    <td class="auto-style34">
                    ...
                    <td class="auto-style33">
                        <asp:TextBox ID="NCTBox" runat="server" Height="23px" required="" style="margin-left: 0px" Width="90%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style34">
                ...
                <tr> <td class="auto-style38" colspan="2"> 
                    <asp:Label ID="Label3" runat="server" Text="Added Successfully" Visible="False" Font-Bold="True"></asp:Label>
                    </td>
                    <td class="auto-style38" colspan="2"> <asp:Button ID="Button1" runat="server" Text="Add" OnClick="Button1_Click" Font-Names="Century Gothic" ForeColor="#990000" Width="50%" /> 
                        <br />
                    </td></tr>
